      ...
      <div className='design-box position-relative'>
        ...
        <div className='std_form confirmoverride'>
          ...
          <FormControl fullWidth  variant="standard">
            ...
            <TextField helperText="A reference to the Attribute that is used in Formulas and Multipliers " label="Value" id="name"  className="white-placeholder"   variant="standard" />
          </FormControl>
          <div className='row'>
            <div className='col-6'>
                <FormControl   variant="standard">
                    ...
                    <TextField id="name"  label="Value"  className="white-placeholder" helperText="Helper Message"   variant="standard" />
                </FormControl>
                ...
                <FormControl   variant="standard">
                    ...
                    <TextField id="name"  helperText="Helper Message"  label="Value"  className="white-placeholder"   variant="standard" />
                </FormControl>
                ...
                <FormControl   variant="standard">
                    ...
                    <TextField id="name"  className="white-placeholder"  variant="standard"  helperText="Helper Message"  label="Value" />
                </FormControl>
                ...
                <FormControl fullWidth  variant="standard">
                    ...
                    <Stack spacing={1} sx={{ width: 300 }}>
                        <Autocomplete
                            ...
                            id="att4"
                            renderInput={(params) => (
                            <TextField {...params} helperText="Helper Message" variant="standard" />
                            )}
                        />
                    </Stack>
                 </FormControl>
