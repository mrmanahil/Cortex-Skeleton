      ...
      <div className='design-box position-relative'>
        ...
        <div className='std_form confirmoverride'>
          ...
          <FormControl fullWidth  variant="standard">
            ...
            <TextField helperText="A reference to the Attribute that is used in Formulas and Multipliers " id="name" label="VFoV" className="white-placeholder"   variant="standard" />
          </FormControl>
          <div className='row'>
            <div className='col-6'>
                ...
                <FormControl   variant="standard">
                    ...
                    <TextField id="name"  helperText="Calculated Value"  label="10"  className="white-placeholder"   variant="standard" />
                </FormControl>
