          ...
          <div className='row'>
            <div className='col-6'>
                <FormControl   variant="standard">
                    ...
                    <TextField id="name"   className="white-placeholder"   variant="standard" />
                </FormControl>
                ...
                <FormControl fullWidth  variant="standard">
                    ...
                    <Stack spacing={1} sx={{ width: 300 }}>
                        <Autocomplete
                            ...
                            id="clear-on-escape"
                            renderInput={(params) => (
                            <TextField {...params} helperText="Measure of Temperature" variant="standard" />
                            )}
                        />
                    </Stack>
                 </FormControl>
