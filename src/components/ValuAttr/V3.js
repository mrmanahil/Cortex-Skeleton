                    ...
                    <item>
                        <div className="geariconHeading">
                            <div className="attribut-head">
                                ...
                                <img src={require('../ValuAttr/setting.png')} />
                            ...
                            <input type="text" id="attribute"
                                ...
                                placeholder="Max Operating Temperature" required="" />
                ...
                <Grid item xs="6" lg="6">
                    <item>
                        <div className="geariconHeading">
                            ...
                            <span class="ref-text new-ref">Helper Message </span>
                        </div>
                    ...
                    <item>
                        <div className="geariconHeading">
                            ...
                            <select id="underline_select"
                                ...
                                <option value="F">FARHENHITE</option>
                                <option value="K">KELVIN</option>
                            </select>
                            <span class="ref-text">Measure of Temperature</span>
                        </div>
                ...
                <Grid item xs="6" lg="6">
                    <item>
                        <div className="geariconHeading">
                            ...
                            <span class="ref-text new-ref ">Calculated by Formula </span>
                        </div>
                ...
                <Grid item xs="6" lg="6">
                    <item>
                        <div className="geariconHeading">
                            ...
                            <span class="ref-text ">Override other values</span>
                        </div>
