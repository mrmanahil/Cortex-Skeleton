...
// }
function createData(result, formula, attr, value, unit) {
  return { result, formula, attr, value, unit };
}
const rows = [
  createData(" ", "A0A0", "Sensor", 3, "Inch"),
  createData(" ", "B1B1", "ObjDist", 28, "meters"),
  createData(" ", "C2C2", "ObjSize", 6, "meters"),
  createData("", "D3D3", "OptFL", 6, "mm"),
];
            ...
            <item>
              <div className="geariconHeading">
                <div className="attribut-head">
                  ...
                  <label
                    for="name"
                    class="block mx-8 font-medium color-text-blue"
                  >
                    Attribute Name
                  </label>
                </div>
          ...
          >
            <TableHead>
              <TableRow>
                ...
                <TableCell className="color-text-blue">
                  Formula Variable
                </TableCell>
                <TableCell className="color-text-blue">
                  Attribute Variable
          ...
          <Grid item lg="12" xs="12">
            <item>
              <div className="geariconHeading">
                ...
                />
                <span class="ref-text">
                  Enter a formula above using Variables above and operators
                  (+-x/()=)
                </span>
              </div>
              <div class="submit-btn">
                <button
                  type="submit"
                  class="bg-lighblue  font-medium   color-dark-blue text-xxl"
                >
                  validate
                </button>
              </div>
