...
function C2(){
    return(
      ...
      <span class="ref-text">A reference to the Attribute</span>
        ...
        class="bg-transparent block color-text-blue"
        placeholder="" required="" />
      <span class="ref-text new-ref">A reference to the Attribute </span>
      </div>
    ...
    <Grid item xs="6" lg="6">
        <item>
            ...
            <label for="text" class="block mx-8 font-medium color-text-blue">Min Value</label>
            </div>
        ...
        <span class="ref-text">Measure Of Distance</span>
      </div>
  ...
  >
    <FormControlLabel value="Expansive" control={<Radio />} label="Expansive"  />
    <FormControlLabel value="Contractive" control={<Radio />} label="Contractive" />
